...
audit_df = DataFrameTransform.create_or_replace_audit_columns(df)
...
results = DataFrameWrite.write_delta_table(
    ...
    table_name=target_hive_table,
    load_type=DataFrameWrite.LoadType.OVERWRITE_TABLE,
    schema_evolution_mode=DataFrameWrite.SchemaEvolutionMode.OVERWRITE_SCHEMA,
)
