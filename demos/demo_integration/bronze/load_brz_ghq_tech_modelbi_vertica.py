...
dbutils.widgets.text("target_hive_database", "brz_ghq_tech_vertica", "5 - target_hive_database")
...
source_location = lakehouse_raw_root_maz + raw_base_path
...
location = lakehouse_utils.generate_bronze_table_location(
    dbutils=dbutils,
    lakehouse_bronze_root=lakehouse_bronze_root_maz,
