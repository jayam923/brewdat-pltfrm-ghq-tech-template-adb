...
dbutils.widgets.text("source_system", "brpsap", "2 - source_system")
...
dbutils.widgets.text("target_hive_database", "brz_ghq_tech_brpsap", "5 - target_hive_database")
...
raw_df = read_utils.read_raw_dataframe(
    ...
    location=f"{lakehouse_raw_root}/data/ghq/tech/brp_sap/supplychain_scfd/",
